...
\begin{frame}[fragile]{To build docomentation}
...
\note{
  To build the documentation, use the devtools function {\tt document()}.
}
\end{frame}
...
Get to know the \href{https://github.com/hadley/devtools}{devtools} package.
...
\item Adopt the tools in the
  \href{https://github.com/hadley/devtools}{devtools} package.
\ei
